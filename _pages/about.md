...
My current research centers around the areas of Automated Vehicle, Smart & Sahred Mobility, and Artificial Intelligence. I aim at developing innovative Deep Learning models for sensing and Deep Reinforcement Learning models for controlling, and thus realize Safe, Efficient, and Socially Compliant Autonomous Driving. I have also delved into shared mobility employing big data analytics and machine learning techniques. My previous works have been published in high quality top journals and conferences, including Transporation Research Part C, IEEE Transactions on Intelligent Transportation Systems, and Computer-Aided Civil and Infrastructure Engineering.

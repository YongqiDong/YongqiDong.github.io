...
12. **Dong, Y.**<sup>#,</sup>\*, Chen, K.<sup>#</sup>, & Ma, Z. (2023). "Comparative Study on Semi-supervised Learning Applied for Anomaly Detection in Hydraulic Condition Monitoring System*, **accepted** by _the 2023 IEEE International Conference on Systems, Man, and Cybernetics (SMC 2023)_,[Preprint](https://arxiv.org/abs/2306.02709)
13. Datema T., Wassenaar, V., **Dong, Y.**\*, van de Weg, J., Suleman, H., & Kopar, T. (2023). "Comparison of Deep Reinforcement Learning Stable Baselines for Automated Driving on Various Driving Maneuvers with Simulation", to be submitted to *the IEEE 26th International Conference on Intelligent Transportation Systems* (ITSC 2023).
